...
public class GestionEquipo extends JFrame implements ActionListener {
    ...
    public GestionEquipo() {
        ...
        //aca van los paneles con mis componentes
    ...
    indiceEquipoSeleccionado = -1; // reiniciar
}
    ...
    private void refrescarTabla() {
        ModeloEquipos.setRowCount(0); // limpiar tabla
    ...
    private void listenerDoubleClick() {
        ...
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getClickCount() == 2) {
                indiceEquipoSeleccionado = tablaEquipos.getSelectedRow(); // guardar índice
                if (indiceEquipoSeleccionado != -1) {
